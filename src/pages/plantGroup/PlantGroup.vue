...
import plantGroupController from "../../controllers/plantGroupController";
...
/* eslint-disable */
export const PlantGroup = /*#__PURE__*/ defineComponent({
  name: "PlantGroup",
  components: {
    MenuSidebar,
    SubHeaderAction,
  ...
  setup() {
    const controllers = plantGroupController();
    ...
    async function fetchUsers(
      ...
      try {
        ...
        const response = await controllers.getplantgroupbysearch(
    ...
    function deleteUser(id: number) {
      if (confirm("Are you sure to delete this Plant Group?")) {
        controllers
          .deleteplantgroup(id)
          .then(() => {
            getUsers();
            toast.add({
              ...
              detail: "Plant Group Successfully Deleted",
              life: 10000,
            });
          })
          .catch((error: any) => {
...
<template>
  ...
  <div class="dashboard-wrapper">
    <section>
      <SubHeaderAction>
        <template v-slot:actionsLeft> Plant Group </template>
