...
/* eslint-disable */
export const CompanyOption = /*#__PURE__*/ defineComponent({
  name: "CompanyOption",
  components: {
    SubHeaderAction,
    TabView,
  ...
  setup() {
    ...
    async function getCustomFields() {
      if (token) {
        const data = await controllers.getcustomfieldbyentity("companies");
...
<template>
  ...
  <div class="dashboard-wrapper">
    <section>
      ...
      <div v-else>
        <SubHeaderAction>
          <template v-slot:actionsLeft>Company Option </template>
