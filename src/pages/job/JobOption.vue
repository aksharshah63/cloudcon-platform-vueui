...
/* eslint-disable */
export const JobOption = /*#__PURE__*/ defineComponent({
  name: "JobOption",
  components: {
    SubHeaderAction,
    TabView,
  ...
  setup() {
    ...
    async function getCustomFields() {
      if (token) {
        const data = await controllers.getcustomfieldbyentity("jobs");
...
<template>
  ...
  <div class="dashboard-wrapper">
    <section>
      ...
      <div v-else>
        <SubHeaderAction>
          <template v-slot:actionsLeft>Job Option </template>
