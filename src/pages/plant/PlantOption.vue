...
/* eslint-disable */
export const PlantOption = /*#__PURE__*/ defineComponent({
  name: "PlantOption",
  components: {
    SubHeaderAction,
    TabView,
  ...
  setup() {
    ...
    async function getCustomFields() {
      if (token) {
        const data = await controllers.getcustomfieldbyentity("plant");
...
<template>
  ...
  <div class="dashboard-wrapper">
    <section>
      ...
      <div v-else>
        <SubHeaderAction>
          <template v-slot:actionsLeft>Plant Option </template>
