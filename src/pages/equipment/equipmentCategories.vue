...
import useControllerProjects from "../../use/controller/equipment/equipmentCategories";
...
export const Equipment = /*#__PURE__*/ defineComponent({
  name: "Projects",
...
<template>
  <dashboard-overview
    ...
    module-name="equipmentCategories"
