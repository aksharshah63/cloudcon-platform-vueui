...
/* eslint-disable */
export const WorkOrder = /*#__PURE__*/ defineComponent({
  name: "WorkOrder",
  components: {
    MenuSidebar,
    SubHeaderAction,
  ...
  setup() {
    ...
    async function fetchWorkorders(
      ...
      try {
        ...
        const response = await controllers.getworkorderbysearch(
    ...
    async function getFilteredWorkorder() {
      try {
    ...
    async function getSortedWorkorders(key: string) {
      try {
        sortKey.value = key;
    ...
    async function getPaginatedWorkorders() {
      try {
        const data = await controllers1.getRecords(
          fetchWorkorders,
          search.value,
...
<template>
  ...
  <div class="dashboard-wrapper">
    <section>
      <SubHeaderAction>
        <template v-slot:actionsLeft> Work Order </template>
          ...
          <div class="datable-view-search">
            <div class="search-bar-container">
              <input
                ...
                v-model="search"
                placeholder="Search"
                v-on:keyup.enter="getFilteredWorkorder()"
              />
                ...
                <div class="p-datatable-wrapper">
                  <table class="p-datatable-table">
                    <thead class="p-datatable-thead">
                      <tr>
                        ...
                        <th
                          ...
                          :key="column.name"
                          @click="getSortedWorkorders(column.name)"
                    ...
                    <tbody class="p-datatable-tbody">
                      <tr v-for="workorder in users" :key="workorder.id">
                        <td>
                          <Checkbox
                            v-model="checked"
                            :inputId="workorder.id"
                            name="category"
