...
/* eslint-disable */
export const Contacts = /*#__PURE__*/ defineComponent({
  name: "Contacts",
  components: {
    MenuSidebar,
    SubHeaderAction,
  ...
  setup() {
    ...
    const columns: any = ref([
      ...
      { label: "Company", name: "jobTitle" },
      { label: "Groups", name: "contactGroups" },
    ...
    async function fetchUsers(
      ...
      try {
        ...
        const response = await controllers.getpeoplebysearch(
...
<template>
  ...
  <div class="dashboard-wrapper">
    <section>
      <SubHeaderAction>
        <template v-slot:actionsLeft> People </template>
                    ...
                    <tbody class="p-datatable-tbody">
                      <tr v-for="user in users" :key="user.id">
                        ...
                        <td>
                          ...
                          >
                            <label
                              v-for="result in user.contactGroups"
                              :key="result"
                              class="contactgroup"
                              >{{ result.name }}</label
                            >
